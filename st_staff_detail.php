...
if (!isset($_SESSION['staffID'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM staff_vehicle_info WHERE ID='$cid' AND StaffID='$staffId'");
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="staff-vehicles.php">Registered Vehicles</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form method="POST" action="st_staff_detail.php?updateid=<?php echo $cid; ?>&staffid=<?php echo $staffId; ?>">

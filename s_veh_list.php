            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            // Fetch vehicles registered for the specific student
                            $query = "SELECT ID, RegistrationNumber, VehicleCategory, VehicleCompanyname, OwnerName, OwnerContactNumber, FineCharge, Remark FROM student_vehicle_info WHERE StudentID = $studentID";

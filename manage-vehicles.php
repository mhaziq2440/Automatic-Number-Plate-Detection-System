<?php
	...
	if(isset($_POST['submit-vehicle'])) {
		...
		$query=mysqli_query($con, "INSERT into vehicle_info(VehicleCategory,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber) value('$catename','$vehcomp','$vehreno','$ownername','$ownercontno')");
		if ($query) {
...
<head>
    ...
    <script>
        function openWebcam() {
            // Open webcam in a new window
            window.open('webcam.php', 'Webcam Scanner', 'width=640, height=480');
        }
    </script>
</head>
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Manage Visitor Entry</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="panel panel-default">
					<div class="panel-heading">Visitor Entry</div>
						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									...
									<button type="button" class="btn btn-primary" onclick="openWebcam()">Capture Number Plate</button>

								</div> <!--  col-md-12 ends -->
							</form>
							    <form action="process_register.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="image"><br>Upload Image for Register:</label>

                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                // Fetch vehicles from the student_pending table
                                $query = "SELECT ID, RegistrationNumber, VehicleCategory, VehicleCompanyname, OwnerName, OwnerContactNumber, Status FROM student_pending WHERE StudentID = $studentID";

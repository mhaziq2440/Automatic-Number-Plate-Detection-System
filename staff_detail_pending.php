...
if (strlen($_SESSION['vpmsaid']) == 0) {
    ...
    if (isset($_GET['detailid'])) {
        ...
        // Fetch the data from the staff_pending table based on detailId
        $query = mysqli_query($con, "SELECT * FROM staff_pending WHERE ID='$detailId'");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["accept"])) {
            ...
            // Update the staff_vehicle_info table with the accepted details
            $query = mysqli_query($con, "INSERT INTO staff_vehicle_info (StaffID, VehicleCategory, VehicleCompanyname, RegistrationNumber, OwnerName, OwnerContactNumber, FineCharge, Remark, StaffName) VALUES ('$staffId', '$category', '$company', '$regNumber', '$ownerName', '$contactNumber', '0', '', '$staffName')");
            
            if ($query) {
                // Update the status in staff_pending table
                mysqli_query($con, "UPDATE staff_pending SET Status='Accepted' WHERE ID='$detailId'");
            ...
            // Update the status in staff_pending table
            mysqli_query($con, "UPDATE staff_pending SET Status='Rejected' WHERE ID='$detailId'");
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Staff Pending Detail</li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Staff Pending Detail</div>
                        ...
                        <div class="col-md-12">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="staffName" value="<?php echo htmlspecialchars($staffName); ?>" readonly>
                                </div>

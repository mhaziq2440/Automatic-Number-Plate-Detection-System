...
if (strlen($_SESSION['staffID'] == 0)) {
    ...
    $updateQuery = "UPDATE staff_vehicle_info SET PaymentMethod='$paymentMethod', BankName='$bankName', CardNumber='$cardNumber', ExpirationDate='$expirationDate' WHERE ID='$fineID'";
    $updateResult = mysqli_query($con, $updateQuery);

    if ($updateResult) {
        // Redirect to the receipt page with the fine ID
        header("Location: st_print_receipt.php?fine_id=$fineID");
        exit();
    } else {

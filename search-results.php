					...
					<div class="panel panel-default">
                        ...
                        <table id="example" class="table table-striped table-hover table-bordered" style="width:100%">
                            ...
                            ?>
                                ...
                                <td><?php echo $row['Fine'] == 1 ? 'Yes' : 'No'; ?></td>
                                
                                <td>
                                    <?php if(empty($row['Status'])): ?>
                                        <a href="update-incomingdetail.php?updateid=<?php echo $row['ID'];?>" class="btn btn-sm btn-info">Take Action</button></a>
                                    <?php elseif (!empty($row['Status'])): ?>
                                        <a href="outgoing-detail.php?updateid=<?php echo $row['ID'];?>" class="btn btn-sm btn-info">View Details</a>
                                        <a href="print-receipt.php?vid=<?php echo $row['ID'];?>" class="btn btn-sm btn-warning">
